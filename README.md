...
- 👨‍💻 Websites I worked on:
  ...
  - Other private projects, including projects with ownership already transferred to other entities.
- My favorite tech stack for web development:
  - Next.js
  - Supabase and Prisma with PostgreSQL
  - Gemini AI API integration
  - Stripe for payment
  - Several serverless tools like Vercel, Upstash, and Resend
